...
public interface EnergySourceMapper {
    ...
    @Mapping(target = "provider", ignore = true)
    EnergySource energySourceJpaEntityToEnergySource(EnergySourceJpaEntity entity);

    @Mapping(target = "provider", ignore = true)
    EnergySourceJpaEntity energySourceToEnergySourceJpaEntity(EnergySource energySource);
}